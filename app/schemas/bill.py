...
class BillCheckResponse(BaseModel):
    ...
    meter_number: str | None = Field(default=None, description="Meter/connection number")
    tariff_class: str | None = Field(default=None, description="Tariff class/category")
    power_rating: str | None = Field(default=None, description="Power rating (PLN only)")
